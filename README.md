...
- [ N/A] Use `npm i live-server` to install the live-server package
- [ N/A] Use `npm run live-server` or `npx live-server --port=5551` to run the live-server. The port number should be 5551 strictly.
